      ...
      <div className="flex h-[80vh]">
        ...
        <div className="flex flex-1 justify-center items-center h-[80vh]">
          <div className="flex flex-col gap-5 w-[68%] items-start">
            <h1 className="font-heading text-[36px] w-[70%] text-very-dark-desaturated-blue leading-tight">
              Standout to the right audience
            </h1>
            <p className="font-body text-dark-grayish-blue font-bold text-[18px] leading-6 ">
              We are a full-service creative agency specializing in helping
              brands grow fast. Engage your clients through compelling visuals
              that do most of the marketing for you.
            </p>
